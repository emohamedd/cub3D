...
/*   Updated: 2023/11/10 18:24:04 by houattou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    data->mlx = mlx_init(SIZE_TITLE * data->map->width,SIZE_TITLE * data->map->height, "MLX42", true);
    data->img = mlx_new_image(data->mlx, 3500, 3500);
